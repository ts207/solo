...
- `docs/research/results.md` — every hypothesis result across the project, regenerated by `project/scripts/update_results_index.py`
- `docs/research/reflections.md` — auto-detected patterns (ceilings, template warnings, regime sensitivity) below the `<!-- AUTO-GENERATED -->` marker; human observations above it
