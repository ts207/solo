...
- `stage_dag.py`: stage-family contract view used by tests and generated artifacts
...
- Generated artifacts should be derived from these contracts rather than edited by hand.
