...
- Planned at: `2026-04-30T19:41:23.585694+00:00`
- Mode: `research`
- Symbols: `BTCUSDT`
- Timeframe: `5m`
...
- `analyze_events__FUNDING_PERSISTENCE_TRIGGER_5m` [selected] family=`phase1_analysis` owner=`project.research.analyze_events`
  outputs: `phase1.events.FUNDING_PERSISTENCE_TRIGGER`
- `build_event_registry__FUNDING_PERSISTENCE_TRIGGER_5m` [selected] family=`phase2_event_registry` owner=`project.research.build_event_registry`
  outputs: `phase2.event_registry.FUNDING_PERSISTENCE_TRIGGER`
- `canonicalize_event_episodes__FUNDING_PERSISTENCE_TRIGGER_5m` [selected] family=`phase2_event_registry` owner=`project.research.build_event_registry`
  outputs: `phase2.event_episodes.FUNDING_PERSISTENCE_TRIGGER`
  inputs: `phase2.event_registry.FUNDING_PERSISTENCE_TRIGGER`
- `analyze_events__OI_SPIKE_POSITIVE_5m` [selected] family=`phase1_analysis` owner=`project.research.analyze_events`
  outputs: `phase1.events.OI_SPIKE_POSITIVE`
- `build_event_registry__OI_SPIKE_POSITIVE_5m` [selected] family=`phase2_event_registry` owner=`project.research.build_event_registry`
  outputs: `phase2.event_registry.OI_SPIKE_POSITIVE`
- `canonicalize_event_episodes__OI_SPIKE_POSITIVE_5m` [selected] family=`phase2_event_registry` owner=`project.research.build_event_registry`
  outputs: `phase2.event_episodes.OI_SPIKE_POSITIVE`
  inputs: `phase2.event_registry.OI_SPIKE_POSITIVE`
...
- `discovery_phase2_candidates` -> `reports/phase2/codex_funding_persistence_oi_2025_shadow_01/phase2_candidates.parquet` (producer=`phase2_discovery`, schema=`phase2_candidates`)
- `run_manifest` -> `runs/codex_funding_persistence_oi_2025_shadow_01/run_manifest.json` (producer=`run_orchestration`, schema=`run_manifest`)
