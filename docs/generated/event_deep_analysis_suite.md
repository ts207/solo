...
- Summary:
  ...
  - `planning_event_count`: `23`
  - `runtime_eligible_event_count`: `9`
  - `promotion_eligible_event_count`: `23`
  - `registered_detector_entry_count`: `73`
  - `alias_count`: `6`

- Details:
  - `runtime_aliases`: `['ABSORPTION_EVENT', 'BASIS_DISLOCATION', 'VOL_REGIME_SHIFT']`
  - `default_executable_but_not_planning`: `['ABSORPTION_PROXY', 'BAND_BREAK', 'BREAKOUT_TRIGGER', 'CHOP_TO_TREND_SHIFT', 'CLIMAX_VOLUME_BAR', 'CROSS_ASSET_DESYNC_EVENT', 'DELEVERAGING_WAVE', 'DEPTH_STRESS_PROXY', 'FAILED_CONTINUATION', 'FALSE_BREAKOUT', 'FEE_REGIME_CHANGE_EVENT', 'FLOW_EXHAUSTION_PROXY', 'FORCED_FLOW_EXHAUSTION', 'GAP_OVERSHOOT', 'LIQUIDATION_CASCADE_PROXY', 'LIQUIDATION_EXHAUSTION_REVERSAL', 'LIQUIDITY_GAP_PRINT', 'LIQUIDITY_STRESS_PROXY', 'MOMENTUM_DIVERGENCE_TRIGGER', 'ORDERFLOW_IMBALANCE_SHOCK', 'OVERSHOOT_AFTER_SHOCK', 'POST_DELEVERAGING_REBOUND', 'PRICE_VOL_IMBALANCE_PROXY', 'PULLBACK_PIVOT', 'RANGE_BREAKOUT', 'RANGE_COMPRESSION_END', 'SLIPPAGE_SPIKE_EVENT', 'SPREAD_BLOWOUT', 'SPREAD_REGIME_WIDENING_EVENT', 'SUPPORT_RESISTANCE_BREAK', 'SWEEP_STOPRUN', 'TREND_ACCELERATION', 'TREND_DECELERATION', 'TREND_EXHAUSTION_TRIGGER', 'TREND_TO_CHOP_SHIFT', 'VOL_CLUSTER_SHIFT', 'VOL_REGIME_SHIFT_EVENT', 'WICK_REVERSAL_PROXY', 'ZSCORE_STRETCH']`
  - `planning_not_default_executable`: `[]`
...
- Details:
  - `maturity_counts`: `{'standard': 62, 'production': 9}`
  - `evidence_tier_counts`: `{'hybrid': 26, 'statistical': 9, 'inferred_cross_asset': 7, 'direct': 20, 'contextual': 4, 'proxy': 1, 'sequence_confirmed': 4}`
  - `issues`: `[{'check_id': 'detector_hardcoded_params', 'severity': 'warning', 'message': 'Detector implementation has hardcoded numerical thresholds: BASIS_DISLOC', 'path': 'project/events/detectors/dislocation_base.py'}, {'check_id': 'detector_hardcoded_params', 'severity': 'warning', 'message': 'Detector implementation has hardcoded numerical thresholds: CROSS_ASSET_DESYNC_EVENT', 'path': 'project/events/detectors/desync_base.py'}, {'check_id': 'detector_hardcoded_params', 'severity': 'warning', 'message': 'Detector implementation has hardcoded numerical thresholds: CROSS_VENUE_DESYNC', 'path': 'project/events/detectors/desync_base.py'}, {'check_id': 'detector_hardcoded_params', 'severity': 'warning', 'message': 'Detector implementation has hardcoded numerical thresholds: FUNDING_EXTREME_ONSET', 'path': 'project/events/detectors/positioning_base.py'}, {'check_id': 'detector_hardcoded_params', 'severity': 'warning', 'message': 'Detector implementation has hardcoded numerical thresholds: FUNDING_NORMALIZATION_TRIGGER', 'path': 'project/events/detectors/positioning_base.py'}, {'check_id': 'detector_hardcoded_params', 'severity': 'warning', 'message': 'Detector implementation has hardcoded numerical thresholds: FUNDING_PERSISTENCE_TRIGGER', 'path': 'project/events/detectors/positioning_base.py'}, {'check_id': 'detector_hardcoded_params', 'severity': 'warning', 'message': 'Detector implementation has hardcoded numerical thresholds: LIQUIDITY_GAP_PRINT', 'path': 'project/events/detectors/liquidity_base.py'}]`
...
- Details:
  ...
  - `planning_event_count`: `23`
  - `non_planning_active_events`: `['ABSORPTION_PROXY', 'BAND_BREAK', 'BREAKOUT_TRIGGER', 'CHOP_TO_TREND_SHIFT', 'CLIMAX_VOLUME_BAR', 'COPULA_PAIRS_TRADING', 'CROSS_ASSET_DESYNC_EVENT', 'DELEVERAGING_WAVE', 'DEPTH_STRESS_PROXY', 'FAILED_CONTINUATION', 'FALSE_BREAKOUT', 'FEE_REGIME_CHANGE_EVENT', 'FLOW_EXHAUSTION_PROXY', 'FORCED_FLOW_EXHAUSTION', 'FUNDING_TIMESTAMP_EVENT', 'GAP_OVERSHOOT', 'LIQUIDATION_CASCADE_PROXY', 'LIQUIDATION_EXHAUSTION_REVERSAL', 'LIQUIDITY_GAP_PRINT', 'LIQUIDITY_STRESS_PROXY', 'MOMENTUM_DIVERGENCE_TRIGGER', 'ORDERFLOW_IMBALANCE_SHOCK', 'OVERSHOOT_AFTER_SHOCK', 'POST_DELEVERAGING_REBOUND', 'PRICE_VOL_IMBALANCE_PROXY', 'PULLBACK_PIVOT', 'RANGE_BREAKOUT', 'RANGE_COMPRESSION_END', 'SCHEDULED_NEWS_WINDOW_EVENT', 'SEQ_FND_EXTREME_THEN_BREAKOUT', 'SEQ_LIQ_VACUUM_THEN_DEPTH_RECOVERY', 'SEQ_OI_SPIKEPOS_THEN_VOL_SPIKE', 'SEQ_VOL_COMP_THEN_BREAKOUT', 'SESSION_CLOSE_EVENT', 'SESSION_OPEN_EVENT', 'SLIPPAGE_SPIKE_EVENT', 'SPREAD_BLOWOUT', 'SPREAD_REGIME_WIDENING_EVENT', 'SUPPORT_RESISTANCE_BREAK', 'SWEEP_STOPRUN', 'TREND_ACCELERATION', 'TREND_DECELERATION', 'TREND_EXHAUSTION_TRIGGER', 'TREND_TO_CHOP_SHIFT', 'VOL_CLUSTER_SHIFT', 'VOL_REGIME_SHIFT_EVENT', 'WICK_REVERSAL_PROXY', 'ZSCORE_STRETCH']`
...
- Summary:
  ...
  - `unique_required_feature_count`: `24`
  - `unique_required_column_count`: `22`
  - `events_missing_required_columns`: `0`

- Details:
  - `top_required_features`: `{'timestamp': 71, 'close': 49, 'rv_96': 20, 'high': 17, 'low': 17, 'oi_delta_1h': 7, 'range_96': 5, 'range_med_2880': 5, 'volume': 5, 'liquidation_notional': 5, 'oi_notional': 5, 'close_perp': 4, 'close_spot': 4, 'ms_oi_state': 3, 'ms_oi_confidence': 3}`
  - `top_required_columns`: `{'timestamp': 71, 'close': 49, 'rv_96': 21, 'high': 17, 'low': 17, 'oi_delta_1h': 7, 'range_96': 6, 'range_med_2880': 6, 'liquidation_notional': 5, 'oi_notional': 5, 'close_perp': 4, 'close_spot': 4, 'volume': 4, 'funding_abs_pct': 3, 'funding_abs': 3}`
