...
- `BASIS_DISLOC` — band `research_trigger`, version `v2`, maturity `production`, runtime `False`, promotion `False`
- `BETA_SPIKE_EVENT` — band `research_trigger`, version `v2`, maturity `specialized`, runtime `False`, promotion `False`
...
- `CORRELATION_BREAKDOWN_EVENT` — band `research_trigger`, version `v2`, maturity `specialized`, runtime `False`, promotion `False`
- `CROSS_VENUE_DESYNC` — band `research_trigger`, version `v2`, maturity `standard`, runtime `False`, promotion `False`
- `DELEVERAGING_WAVE` — band `research_trigger`, version `v1`, maturity `specialized`, runtime `False`, promotion `False`
- `DEPTH_COLLAPSE` — band `research_trigger`, version `v2`, maturity `standard`, runtime `False`, promotion `False`
- `DEPTH_STRESS_PROXY` — band `composite_or_fragile`, version `v1`, maturity `standard`, runtime `False`, promotion `False`
...
- `INDEX_COMPONENT_DIVERGENCE` — band `research_trigger`, version `v2`, maturity `specialized`, runtime `False`, promotion `False`
- `LEAD_LAG_BREAK` — band `research_trigger`, version `v2`, maturity `specialized`, runtime `False`, promotion `False`
- `LIQUIDATION_CASCADE` — band `deployable_core`, version `v2`, maturity `production`, runtime `True`, promotion `True`
- `LIQUIDATION_CASCADE_PROXY` — band `composite_or_fragile`, version `v2`, maturity `experimental`, runtime `False`, promotion `False`
...
- `OI_SPIKE_NEGATIVE` — band `deployable_core`, version `v2`, maturity `specialized`, runtime `True`, promotion `False`
...
- `SWEEP_STOPRUN` — band `research_trigger`, version `v1`, maturity `standard`, runtime `False`, promotion `False`
...
- `VOL_RELAXATION_START` — band `research_trigger`, version `v2`, maturity `specialized`, runtime `False`, promotion `False`
- `VOL_SHOCK` — band `research_trigger`, version `v2`, maturity `production`, runtime `False`, promotion `False`
- `VOL_SPIKE` — band `research_trigger`, version `v2`, maturity `production`, runtime `False`, promotion `False`
- `WICK_REVERSAL_PROXY` — band `composite_or_fragile`, version `v1`, maturity `standard`, runtime `False`, promotion `False`
