...
| LIQUIDATION_CASCADE_PROXY | v2 | trigger | composite_or_fragile | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | promotion-eligible detector; keep on the governed v2 migration path |
