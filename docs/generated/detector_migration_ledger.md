...
| BREAKOUT_TRIGGER | v1 | trigger | research_trigger | research_perimeter | keep_v1 | workstream_b | legacy research trigger still available for planning but not promoted to v2 yet |
...
| OI_SPIKE_NEGATIVE | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | promotion-eligible detector; keep on the governed v2 migration path |
...
| RANGE_COMPRESSION_END | v1 | trigger | research_trigger | research_perimeter | keep_v1 | workstream_b | legacy research trigger still available for planning but not promoted to v2 yet |
...
| VOL_CLUSTER_SHIFT | v1 | trigger | research_trigger | research_perimeter | keep_v1 | workstream_b | legacy research trigger still available for planning but not promoted to v2 yet |
| VOL_REGIME_SHIFT_EVENT | v1 | trigger | research_trigger | research_perimeter | keep_v1 | workstream_b | legacy research trigger still available for planning but not promoted to v2 yet |
