...
| BAND_BREAK | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| BASIS_DISLOC | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | v2 research trigger retained on the governed migration path |
| BETA_SPIKE_EVENT | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | v2 research trigger retained on the governed migration path |
...
| CHOP_TO_TREND_SHIFT | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| CLIMAX_VOLUME_BAR | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
...
| CORRELATION_BREAKDOWN_EVENT | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | v2 research trigger retained on the governed migration path |
...
| CROSS_VENUE_DESYNC | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | v2 research trigger retained on the governed migration path |
| DELEVERAGING_WAVE | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| DEPTH_COLLAPSE | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | v2 research trigger retained on the governed migration path |
...
| FAILED_CONTINUATION | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| FALSE_BREAKOUT | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| FEE_REGIME_CHANGE_EVENT | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
...
| FND_DISLOC | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | v2 research trigger retained on the governed migration path |
| FORCED_FLOW_EXHAUSTION | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| FUNDING_EXTREME_ONSET | v2 | context | context_only | research_perimeter | demote | workstream_b | context marker; keep behind adapter boundaries and out of runtime/promotion |
...
| LIQUIDITY_VACUUM | v2 | context | context_only | runtime_core_first | migrate_to_v2 | workstream_c | deployable core runtime detector; keep fully v2 and contract-complete |
| LIQUIDITY_VACUUM_RECOVERY | v2 | trigger | research_trigger | runtime_core_first | migrate_to_v2 | workstream_c | deployable core runtime detector; keep fully v2 and contract-complete |
...
| OI_EXPANSION_STRESS | v2 | context | context_only | runtime_core_first | migrate_to_v2 | workstream_c | deployable core runtime detector; keep fully v2 and contract-complete |
| OI_FLUSH | v2 | trigger | research_trigger | runtime_core_first | migrate_to_v2 | workstream_c | deployable core runtime detector; keep fully v2 and contract-complete |
| OI_SPIKE_NEGATIVE | v2 | context | context_only | runtime_core_first | migrate_to_v2 | workstream_c | deployable core runtime detector; keep fully v2 and contract-complete |
...
| POST_DELEVERAGING_REBOUND | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
...
| PULLBACK_PIVOT | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| RANGE_BREAKOUT | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
...
| SLIPPAGE_SPIKE_EVENT | v1 | context | context_only | research_perimeter | wrap_v1 | workstream_b | context marker; keep behind adapter boundaries and out of runtime/promotion |
| SPOT_PERP_BASIS_SHOCK | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | v2 research trigger retained on the governed migration path |
| SPREAD_BLOWOUT | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| SPREAD_REGIME_WIDENING_EVENT | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| SUPPORT_RESISTANCE_BREAK | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| SWEEP_STOPRUN | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| TREND_ACCELERATION | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| TREND_DECELERATION | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| TREND_EXHAUSTION_TRIGGER | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
| TREND_TO_CHOP_SHIFT | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
...
| VOL_RELAXATION_START | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | v2 research trigger retained on the governed migration path |
| VOL_SHOCK | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | v2 research trigger retained on the governed migration path |
| VOL_SPIKE | v2 | trigger | research_trigger | promotion_eligible_middle_layer | migrate_to_v2 | workstream_c | v2 research trigger retained on the governed migration path |
...
| ZSCORE_STRETCH | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
