...
| SLIPPAGE_SPIKE_EVENT | v1 | trigger | research_trigger | research_perimeter | retire | workstream_b | legacy detector outside the default planning surface; retire instead of migrating |
