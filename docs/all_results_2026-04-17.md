...
*Covers all evaluation_results, phase2 hypotheses, and campaign summaries across the full project history.*
*89 unique results across 20 events. Gates: bridge = t ≥ 2.0 AND rob ≥ 0.70; phase2 = rob ≥ 0.60.*
...
|-------|-----|---------|----------|---|-----|---|-----------|--------|
| BETA_SPIKE_EVENT | long | 24b | mean_reversion | — | — | — | 0.0 | no events |
...
| FAILED_CONTINUATION | long | 48b | exhaustion_reversal | -0.81 | 0.506 | 1.0000 | -13.8 | negative |
| FORCED_FLOW_EXHAUSTION | long | 48b | exhaustion_reversal | 1.40 | 0.599 | 0.0807 | 30.4 | below gate |
| LIQUIDATION_CASCADE | long | 24b | exhaustion_reversal | 1.78 | 0.818 | 0.0372 | 23.8 | **PROMOTED** |
...
| OI_SPIKE_NEGATIVE | long | 24b | exhaustion_reversal | 2.28 | 0.848 | 0.0112 | 51.5 | **PROMOTED** |
...
| RANGE_COMPRESSION_END | long | 24b | mean_reversion | — | — | 0.4760 | -7.4 | no events |
| TREND_EXHAUSTION_TRIGGER | long | 48b | exhaustion_reversal | — | — | — | 0.0 | no events |
| VOL_CLUSTER_SHIFT | long | 24b | mean_reversion | — | — | 0.9540 | -10.7 | no events |
| VOL_REGIME_SHIFT_EVENT | long | 24b | mean_reversion | — | — | — | 0.0 | no events |
| VOL_RELAXATION_START | long | 24b | mean_reversion | — | — | — | 0.0 | no events |
| VOL_SHOCK | long | 12b | mean_reversion | 0.62 | 0.415 | 1.0000 | 6.7 | below gate |
...
|-----|---------|----------|---|-----|---|---|-----------|--------|------------|
| long | 24b | mean_reversion | — | — | 0 | — | 0.0 | no events | `beta_spike_event_mr_24b` |
...
| dir | horizon | template | t | rob | n | q | exp (bps) | status | program_id |
|-----|---------|----------|---|-----|---|---|-----------|--------|------------|
| long | 48b | exhaustion_reversal | -0.81 | 0.506 | 262 | 1.0000 | -13.8 | negative | `failed_continuation` |
...
| long | 8b | exhaustion_reversal | 2.40 | 0.836 | 65 | 0.0163 | 27.1 | bridge gate | `liqdirect_targeted_20210413_c` |
| long | 16b | exhaustion_reversal | 2.35 | 0.830 | 110 | 0.0094 | 25.6 | bridge gate | `liqh16_20210413_a` |
| long | 16b | mean_reversion | 2.35 | 0.830 | 110 | 0.0094 | 25.6 | bridge gate | `h16` |
...
| long | 24b | exhaustion_reversal | 1.78 | 0.818 | 94 | 0.0372 | 23.8 | **PROMOTED** | `std_gate_2yr` |
...
| long | 24b | exhaustion_reversal | 1.26 | 0.512 | 91 | 0.1035 | 12.8 | below gate | `std_gate_exhaustion` |
...
| long | 12b | mean_reversion | 1.01 | 0.525 | 91 | 1.0000 | 7.8 | below gate | `standard_gate_v1` |
| long | 24b | exhaustion_reversal | — | — | 0 | — | — | no events | `std_gate_eth` |
| short | 24b | exhaustion_reversal | — | — | — | — | — | no events | `std_gate_short` |
...
| dir | horizon | template | t | rob | n | q | exp (bps) | status | program_id |
|-----|---------|----------|---|-----|---|---|-----------|--------|------------|
| long | 24b | mean_reversion | — | — | — | 0.4760 | -7.4 | no events | `range_compression_end_mr_24b` |

## TREND_EXHAUSTION_TRIGGER

| dir | horizon | template | t | rob | n | q | exp (bps) | status | program_id |
|-----|---------|----------|---|-----|---|---|-----------|--------|------------|
| long | 48b | exhaustion_reversal | — | — | 0 | — | 0.0 | no events | `trend_exhaustion_trigger` |

## VOL_CLUSTER_SHIFT

| dir | horizon | template | t | rob | n | q | exp (bps) | status | program_id |
|-----|---------|----------|---|-----|---|---|-----------|--------|------------|
| long | 24b | mean_reversion | — | — | — | 0.9540 | -10.7 | no events | `vol_cluster_shift_mr_24b` |

## VOL_REGIME_SHIFT_EVENT

| dir | horizon | template | t | rob | n | q | exp (bps) | status | program_id |
|-----|---------|----------|---|-----|---|---|-----------|--------|------------|
| long | 24b | mean_reversion | — | — | 0 | — | 0.0 | no events | `vol_regime_shift_event_mr_24b` |

## VOL_RELAXATION_START

| dir | horizon | template | t | rob | n | q | exp (bps) | status | program_id |
|-----|---------|----------|---|-----|---|---|-----------|--------|------------|
| long | 24b | mean_reversion | — | — | 0 | — | 0.0 | no events | `vol_relaxation_start_mr_24b` |

## VOL_SHOCK

| dir | horizon | template | t | rob | n | q | exp (bps) | status | program_id |
|-----|---------|----------|---|-----|---|---|-----------|--------|------------|
| long | 12b | mean_reversion | 0.62 | 0.415 | 318 | 1.0000 | 6.7 | below gate | `vol_shock_long_mr_12b` |
| long | 24b | continuation | 0.62 | 0.414 | 318 | 1.0000 | 4.7 | below gate | `vol_shock_long_cont_24b` |
| long | 24b | mean_reversion | -0.62 | 0.377 | 318 | 1.0000 | -6.7 | negative | `vol_shock_long_mr_24b` |
...
| short | 12b | continuation | -1.08 | 0.598 | 678 | 1.0000 | -12.2 | negative | `vol_spike_short_12b` |
