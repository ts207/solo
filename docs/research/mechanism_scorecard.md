...
| stop_run_reversal | draft | 0 | 0 | 0 |  |  |  |  | compile one bounded proposal or update mechanism observables |
| volatility_compression_release | draft | 0 | 0 | 0 |  |  |  |  | compile one bounded proposal or update mechanism observables |
